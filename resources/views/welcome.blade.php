    ...
    @include('header')
      ...
      <div class="MAIN_INSCRIPCIONES mt-ml-10">
        <div class="row">
          <div class="col-12 p-4 mx-auto">
            <h2 class="section-title-underline my-5">
              <span>Consulta aquí nuestros certificados expedidos!</span>
            </h2>
            <div>
            ...
            @foreach ($users as $user)
              <div class="col-lg-4 col-md-6 mb-5 mb-lg-5">  
                <div class="feature-1 border person text-center">
                    <img src="img/{{ $user->photo}}" alt="Image" class="img-fluid">
                  <div class="feature-1-content">
                    <h2>{{ $user->name}}</h2>
                    <span class="position mb-3 d-block">{{ $user->titulo}}</span>    
