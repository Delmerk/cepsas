...
class InscripcionController extends Controller
{
    ...
    public function index()
    {
        ...
        $inscripciones = Inscripcion::join('users','inscripciones.id_alumno','=','users.id')
            ...
            ->select('inscripciones.id as id','cursos.nombre as curso','cursos.id as id_curso', 'users.name as name', 'users.id as id_alumno', 'inscripciones.fecha as fecha', 'inscripciones.estado as estado', 'inscripciones.fec_activa as fec_activa', 'inscripciones.fec_cancela as fec_cancela', 'inscripciones.fec_cancela as fec_cancela', 'inscripciones.fec_termina as fec_termina','inscripciones.created_at as created_at','cursos.created_at as cd','users.created_at as ucd')
    ...
    public function search ()
    {
        if ($search = \Request::get('q')) {
            ...
            */
            $inscripciones = Inscripcion::join('users','inscripciones.id_alumno','=','users.id')
            ->join('cursos','inscripciones.id_curso','=','cursos.id')
            ->where('cursos.nombre', 'LIKE', "%$search%")
            ...
            ->orderBy('inscripciones.id', 'desc')->paginate(10);
            return $inscripciones;
            ...
            ->join('cursos','inscripciones.id_curso','=','cursos.id')            
            ->select('inscripciones.id as id','cursos.nombre as curso','cursos.id as id_curso', 'users.name as name', 'users.id as id_alumno', 'inscripciones.fecha as fecha', 'inscripciones.estado as estado', 'inscripciones.fec_activa as fec_activa', 'inscripciones.fec_cancela as fec_cancela', 'inscripciones.fec_cancela as fec_cancela', 'inscripciones.fec_termina as fec_termina')
            ->orderBy('inscripciones.id', 'desc')->latest()->paginate(10);
            //$inscripcions = Inscripcion::latest()->paginate(10);
            return $inscripciones;
        }
        
    }

    public function inscribirme($id_curso) {
      /*  $user = \Auth::user();
    ...
    public function findMisInscripciones($buscar = null) {
        ...
        if($buscar != '') {
            ...
            ->select('inscripciones.id as id','cursos.nombre as curso','cursos.id as id_curso', 'users.name as name', 'users.id as id_alumno', 'inscripciones.fecha as fecha', 'inscripciones.estado as estado', 'inscripciones.fec_activa as fec_activa', 'inscripciones.fec_cancela as fec_cancela', 'inscripciones.fec_cancela as fec_cancela', 'inscripciones.fec_termina as fec_termina')
            ->orderBy('inscripciones.id', 'desc')->paginate(100);
        }
        else {
